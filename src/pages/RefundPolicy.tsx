...
export const RefundPolicy: React.FC<RefundPolicyProps> = ({ navigate }) => {
  const { pageContent, siteSettings } = useApp();
  const refund = pageContent.refund;
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex items-center gap-3 text-amber-400 mb-2">
            ...
            <span className="text-xs font-bold uppercase tracking-widest">Satisfaction Guarantee</span>
          </div>
          ...
          <div className="flex items-center gap-2 text-xs text-slate-400 mt-3">
            ...
            <span>Last Updated: {refund.lastUpdated || 'August 7, 2026'}</span>
            <span>•</span>
